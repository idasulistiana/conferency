<div id="body">
	...
	<div class="form-group">
		<label for="inputLastName" class="col-md-4">Company Name</label>
	    <div class="col-md-8">
	    	<input type="text" class="form-control" name="company" id="company" placeholder="Company/University Name" required>
	    </div>
	 </div>
	 <div class="form-group">
	 	<label for="inputLastName" class="col-md-4">City</label>
	    <div class="col-md-8">
	    	<input type="text" class="form-control" name="city" id="city" placeholder="City" required>
	    </div>
	 </div>
	 <div class="form-group">
	 	<label for="inputLastName" class="col-md-4">State</label>
	    <div class="col-md-8">
	    	<input type="text" class="form-control" name="state" id="state" placeholder="State" required>
	    </div>
	</div>
	<div class="form-group">
		<label for="selectCountry" class="col-md-4">Country*</label>
	    <div class="col-md-8">
	...
	<div class="form-group">
		<label for="inputPhoneNumber" class="col-md-4">Phone Number*</label>
		<div class="col-md-8">
	...
	<div class="form-group">
		<label for="inputAbsCategory" class="col-md-4">Abstract Category</label>
		<div class="col-md-8">
			<input type="text" class="form-control" name="category" id="category" placeholder="Your Abstract Category">
		</div>
	</div>
	<div class="form-group">
		<label for="titleSpeech" class="col-md-4">Title of the speech</label>
		<div class="col-md-8">
