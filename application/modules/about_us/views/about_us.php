		...
		<div id="content">
				  ...
				  <div class="panel panel-default">
				    <div class="panel-heading">
				      <h4 class="panel-title">
				        <a data-toggle="collapse" href="#collapse1">SBRC</a>
				      </h4>
				    </div>
				    <div id="collapse1" class="panel-collapse collapse">
				      <div class="panel-body"><a href="#about">About SBRC</a></div>
				      <div class="panel-footer"><a href="#awards">Awards</a></div>
				    </div>
				  </div>
				  <div class="panel panel-default">
				    <div class="panel-heading">
			...
			<div id="section">
				...
				<ol style="margin-left: -25px;">
					<li align="justify">
						The award of  Excellence Intellectual Property Right  from Ministry of Education and Culture Republic of Indonesia in 2012
					</li>
					<li align="justify">The award of West Java Inovation from Government of West Java Province in 2014</li>
					<li align="justify">The award of The Best Initiative Community from Ministry of Energy and Mineral Resources Republic Indonesia in 2014</li>
					<li align="justify">
						The award one of 20 Indonesian Excellent Technology from Ministry of Research, Technology and Higher Education Republic of Indonesia in 2015
					</li>
					<li align="justify">
						One of 12 World Class Indonesian Innovators from Business Innovation Center-Ministry of Research, Technology and Higher Education  in 2015
					</li>
					<li align="justify">
						Center of Excellence focus on Surfactan and Bioenergy from Ministry of Research, Technology and Higher Education Republic of Indonesia in 2015
					</li>
				</ol>
				</div>
			</div>
